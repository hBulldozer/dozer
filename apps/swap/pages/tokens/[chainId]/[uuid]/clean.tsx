import { AppearOnMount, BreadcrumbLink, Button, Dialog, Container, Typography } from '@dozer/ui'
...
const TokenClean = ({ tokenInfo }: { tokenInfo: AllTokensDBOutput }) => {
  ...
  const initialCurrency = isHtr ? 'USD' : 'HTR'
        ...
        <Container className="py-8">
          <div className="flex flex-col lg:grid lg:grid-cols-[568px_auto] gap-12">
            ...
            <div className="flex-col order-2 hidden gap-4 lg:flex">
              <AppearOnMount>
                <SwapWidget token0_idx={'00'} token1_idx={uuid} />
              </AppearOnMount>
            </div>
          </div>
