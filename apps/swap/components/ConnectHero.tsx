...
import { Button as ConnectButton } from '@dozer/higmi/components/Wallet/Button'
...
export const ConnectHero: FC = () => {
  ...
  return (
    <section className="relative px-4 py-20 mt-24 sm:py-40 ">
                    ...
                    <div className="p-3 pt-0">
                      ...
                      >
                        <div className="relative z-10">
                          <ConnectButton fullWidth size="md" />
                        </div>
                      </motion.div>
                    </div>
                  </div>
