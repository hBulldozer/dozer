...
import { Button, CopyHelper, Link, Typography } from '@dozer/ui'
        ...
        <div className="flex flex-col space-y-4 p-6 rounded-xl bg-black bg-opacity-70 border border-yellow-500/20 shadow-lg shadow-yellow-500/10">
          ...
          <div className="flex flex-col space-y-2">
            ...
            <div className="flex items-center p-3 bg-stone-900 rounded-lg overflow-hidden">
              ...
              <CopyHelper className="flex-shrink-0 ml-2" toCopy={addresses[selectedNetwork]}>
          ...
          <div className="flex flex-col mt-4">
            ...
            <Link.External href="https://t.me/dozerportal" className="flex items-center gap-2">
              <Button
                size="lg"
