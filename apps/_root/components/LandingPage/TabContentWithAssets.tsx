...
const TabContentWithAssets: React.FC<TabContentWithAssetsProps> = memo(
  ({ activeTab }) => {
            ...
            <div className="flex flex-col gap-6 sm:justify-center">
              <div className="flex flex-col gap-2">
                ...
                <Typography variant="lg" weight={400} className="mb-4 opacity-60">
                  Dozer Finance is bringing innovation to DeFi with lightning-fast transactions and minimal fees. Join
                  us in shaping the future of decentralized finance.
                </Typography>
              </div>
