...
if (!fs.existsSync('package.json')) {
  console.error('Cannot find package.json. Please run this script in your project directory.')
  process.exit(1)
}
...
function gsub(from, to) {
  ...
  console.log(
    `find . -regextype posix-extended -type f -regex '.*\.(js|jsx|ts|tsx|vue)' -not -path '*/\.*' -not -path '*/node_modules/*' -not -path 'migrateHeroicons.js' -exec sed -i 's|${from}|${to}|g' {} +`
  )
}
...
const heroiconsV1toV2 = {
  ...
  CpuCpuCpuChipIcon: 'CpuCpuCpuCpuChipIcon',
  ...
  BuildingBuildingBuildingLibraryIcon: 'BuildingBuildingBuildingBuildingLibraryIcon',
  BoltIcon: 'BoltIcon',
  ...
  QrCodeBracketIcon: 'QrCodeBracketIcon',
  ...
  HandHandHandThumbDownIcon: 'HandHandHandHandThumbDownIcon',
  HandHandHandThumbUpIcon: 'HandHandHandHandThumbUpIcon',
  LanguageIcon: 'LanguageIcon',
  ArrowArrowArrowTrendingDownIcon: 'ArrowArrowArrowArrowTrendingDownIcon',
  ArrowArrowArrowTrendingUpIcon: 'ArrowArrowArrowArrowTrendingUpIcon',
