  ...
  return (
    <Layout>
      ...
      <div className="mx-auto prose prose-dark">
        ...
        <p className="leading-6 text-neutral-400">
          Dozer makes no representations as to the accuracy, completeness, timeliness, suitability, or validity of any
          ...
          property of Dozer. Links provided to third-party sites are for informational purposes. Such sites are not
          under the control of Dozer, and Dozer is not responsible for the accuracy of the content on such third-party
          sites.
        </p>
      </div>
    </Layout>
