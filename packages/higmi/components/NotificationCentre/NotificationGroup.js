          ...
          { className: 'relative' },
          {
            children: [
              notifications.length > 1 &&
                open &&
                _jsx('div', {
                  className: 'absolute left-[33px] top-7 bottom-7 w-0.5 bg-gradient-to-b from-stone-700 to-yellow',
                }),
              _jsx(Notification, { data: notifications[0], showExtra: notifications.length > 1 }),
              notifications.length > 1 &&
