...
import { Amount, Currency } from '@dozer/currency'
import { Badge, Button, classNames, Currency as CurrencyFromUi, IconButton, Tooltip, Typography } from '@dozer/ui'
...
export const TokenApproveButton: FC<TokenApproveButton> = memo(
  ({
    ...
    const [approvalState, onApprove] = [ApprovalState.PENDING, () => {}]
    ...
    return (
      <Transition
        unmount={false}
        show={
          !allApproved && initialized && amount && !amount.currency && ![ApprovalState.UNKNOWN].includes(approvalState)
        }
              ...
              <div>
                ...
                >
                  <IconButton
                    ...
                    onClick={onApprove}
                  >
                    {amount && <CurrencyFromUi.Icon currency={amount?.currency} width={24} height={24} />}
                  </IconButton>
                </Badge>
              </div>
            }
