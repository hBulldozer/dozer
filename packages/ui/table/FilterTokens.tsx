...
export interface FiltersTokens {
...
export type FilterTokensProps = {
  ...
  setFilters: (filters: FiltersTokens) => void
...
export function FilterTokens({ search, setSearch, setFilters, maxValues }: FilterTokensProps) {
  const [localFilters, setLocalFilters] = useState<FiltersTokens>({
    tvl: {},
    volume: {},
    price: {},
    marketcap: {},
  ...
  const resetFilters = () => {
    const resetFilters: FiltersTokens = {
      tvl: {},
      volume: {},
      price: {},
      marketcap: {},
