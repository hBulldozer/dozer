...
export const DEFAULT_INPUT_RING =
  'focus-within:ring-2 focus:outline-none border-none focus:ring-2 focus:ring-offset-2 focus-within:ring-offset-2 ring-yellow focus:ring-yellow focus-within:ring-yellow'
