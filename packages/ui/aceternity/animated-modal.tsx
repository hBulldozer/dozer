...
export const ModalContent = ({ children, className }: { children: ReactNode; className?: string }) => {
  return <div className={classnames('flex flex-col flex-1 p-8 md:p-10', className)}>{children}</div>
}

export const ModalFooter = ({ children, className }: { children: ReactNode; className?: string }) => {
  return <div className={classnames('flex justify-end p-4 bg-gray-100 dark:bg-neutral-900', className)}>{children}</div>
}
