      ...
      <AnimatePresence mode="wait">
        <motion.div className="relative h-full w-full" initial="initial" whileHover={direction} exit="exit">
          ...
          >
            <Image
              alt="image"
              className={classnames('h-full w-full object-cover scale-[1.15]', imageClassName)}
              width="1000"
              height="1000"
              src={imageUrl}
            />
          ...
          <motion.div
            ...
            className={classnames('text-white absolute bottom-4 left-4 z-40', childrenClassName)}
          >
            {children}
          </motion.div>
        </motion.div>
