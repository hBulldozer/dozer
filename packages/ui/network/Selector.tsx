        ...
        const button = (
          <div
            ...
            className={classNames(
              className,
              selectedNetworks.includes(chainId) ? 'bg-stone-700 border-transparent' : 'border-stone-800',
              'hover:ring-2 ring-stone-800 ring-offset-2 ring-offset-stone-900 border-2 rounded-xl overflow-hidden cursor-pointer p-2'
            )}
          >
