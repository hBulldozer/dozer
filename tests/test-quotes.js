...
const POOL_MANAGER_CONTRACT_ID = process.env.POOL_MANAGER_CONTRACT_ID || '0000626e3c230f011a5084c58806a83e4af4db0fd55d320f527d19aa1bf30a25';
const HATHOR_NODE_URL = process.env.NEXT_PUBLIC_LOCAL_NODE_URL || process.env.NEXT_PUBLIC_PUBLIC_NODE_URL || 'https://node1.nano-testnet.hathor.network/v1a';
...
async function testContract() {
  try {
    ...
    const quoteResult2 = quoteResponse2.calls[`front_quote_exact_tokens_for_tokens("${firstPool}",${amount},"${tokenA}")`]?.value;
    ...
    const quoteResult3 = quoteResponse3.calls[`find_best_swap_path_str(${smallAmount},"${tokenA}","${tokenB}",3)`]?.value;
